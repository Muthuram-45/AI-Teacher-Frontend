    ...
    useEffect(() => {
        ...
        const handleData = async (payload, _participant, kind) => {
            ...
            try {
                ...
                /* 🎤 VOICE DOUBT INTENT (When student says "Hi/Doubt") */
                if (msg.action === 'VOICE_DOUBT_INTENT') {
                    await speakText(`Yes ${msg.name}, please ask your question.`);
                }

                /* 💬 STUDENT DOUBT RECEIVED */
                if (msg.action === 'STUDENT_DOUBT') {
                    // A real doubt was sent
                }
            } catch (e) {
